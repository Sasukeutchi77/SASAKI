  ...
  const users: UserWithPassword[] = [
    {
      ...
      name: 'Administrateur FasoInfo',
      role: 'admin',
      isVerified: true,
      status: 'active',
      avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80',
      bio: 'Équipe de modération et administration de la plateforme FasoInfo.',
...
Ce dispositif facilitera considérablement les transactions commerciales transfrontalières par monnaie électronique pour les commerçants, transporteurs et citoyens de l'espace communautaire.`,
  ...
  const mediaHouses: MediaHouse[] = [
    ...
    },
    {
      ...
      ownerId: 'usr_admin',
      ownerName: 'Administrateur FasoInfo',
  ...
  const adminLogs: AdminLog[] = [
    {
      id: 'log_1',
      adminId: 'usr_admin',
      adminName: 'Administrateur FasoInfo',
