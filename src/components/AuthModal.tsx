...
export const AuthModal: React.FC<AuthModalProps> = ({ onClose, initialMode = 'login' }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-3 sm:p-4 overflow-y-auto">
      <div className="relative w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col my-4 max-h-[92vh]">
        {/* Modal Header */}
        <div className="bg-stone-50 border-b border-stone-200 px-6 py-4 flex items-center justify-between shrink-0">
          <div>
            <h2 className="text-lg font-black text-stone-900">
              {mode === 'login' && 'Connexion à FasoInfo'}
        ...
        <div className="px-6 py-3 bg-stone-100/80 border-b border-stone-200 text-stone-700">
          ...
          <div className="grid grid-cols-4 gap-1.5 text-center">
            <button
              ...
              className="px-2 py-1 bg-white hover:bg-emerald-50 text-stone-800 text-[11px] font-bold rounded-lg border border-stone-200 transition-colors shadow-2xs"
            >
              Lecteur
            </button>
            <button
        ...
        <div className="p-6 overflow-y-auto flex-1 space-y-4">
          ...
          {mode !== 'forgot' && (
            <div className="space-y-3">
              <button
                ...
                className="w-full py-2.5 px-4 bg-white hover:bg-stone-50 text-stone-800 border border-stone-300 rounded-xl text-xs font-bold transition-all shadow-xs flex items-center justify-center gap-3 disabled:opacity-50"
              >
              ...
              <div className="relative flex items-center justify-center">
                ...
                <span className="bg-white px-3 text-[11px] font-bold text-stone-400 uppercase">
                  ou avec votre email
                </span>
              </div>
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-2 text-xs bg-stone-50 border border-stone-200 rounded-lg focus:outline-none focus:border-emerald-600 focus:bg-white"
                  />
                </div>
              </div>
            )}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2.5 bg-emerald-600 hover:bg-emerald-700 disabled:opacity-50 text-white rounded-xl text-xs font-bold shadow-sm transition-all flex items-center justify-center gap-1.5"
            >
              <span>
                {loading
                  ? 'Traitement en cours...'
