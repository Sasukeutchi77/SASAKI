...
export const ArticleDetailModal: React.FC<ArticleDetailModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-0 sm:p-4 overflow-y-auto">
      <div className="relative w-full max-w-4xl bg-white min-h-screen sm:min-h-0 sm:rounded-2xl shadow-2xl sm:my-8 overflow-hidden flex flex-col">
        {/* Top Sticky Header */}
              ...
              <>
                {onOpenEditArticle && (
                  <button
                    ...
                    className="p-2 text-stone-600 hover:text-emerald-700 hover:bg-stone-100 rounded-full cursor-pointer"
                ...
                <button
                  ...
                  className="p-2 text-stone-600 hover:text-red-600 hover:bg-red-50 rounded-full cursor-pointer"
        ...
        {loading || !article ? (
          ...
          <div className="p-4 sm:p-8 flex-1 overflow-y-auto">
            {/* Article Title */}
            <h1 className="text-xl sm:text-3xl font-black text-stone-900 leading-tight tracking-tight">
              {article.title}
            </h1>

            {/* Author Box */}
            <div className="mt-5 p-4 rounded-xl bg-stone-50 border border-stone-200/80 flex flex-wrap items-center justify-between gap-4">
              <button
              ...
              >
                <img
                  ...
                  className="w-12 h-12 rounded-full object-cover border border-stone-200 group-hover:ring-2 group-hover:ring-emerald-600 transition-all"
                />
                <div>
                  <div className="flex items-center gap-1.5 font-bold text-sm sm:text-base text-stone-900 group-hover:text-emerald-700 transition-colors">
            ...
            {/* Date & Stats bar */}
            <div className="mt-4 flex flex-wrap items-center gap-4 text-xs text-stone-500 pb-4 border-b border-stone-100">
              <span>
                Publié le{' '}
            ...
            {/* Main Cover Image */}
            {article.coverImage && (
              <div className="mt-6 rounded-2xl overflow-hidden bg-stone-100 aspect-[16/9] shadow-sm">
                <img
            ...
            {article.summary && (
              <div className="mt-6 p-4 rounded-xl bg-amber-50/70 border-l-4 border-amber-600 text-stone-800 font-medium text-sm sm:text-base leading-relaxed italic">
                « {article.summary} »
              </div>
            )}
            ...
            {article.videoUrl && (
              <div className="mt-6">
                <div className="mb-2 flex items-center gap-2">
                  ...
                  <h3 className="font-bold text-sm text-stone-900">Reportage vidéo exclusif :</h3>
                </div>
                <VideoPlayer
            ...
            <div className="mt-6 text-stone-800 text-base sm:text-lg leading-relaxed whitespace-pre-line font-normal">
              {article.content}
            </div>
            ...
            {article.tags && article.tags.length > 0 && (
              <div className="mt-8 flex flex-wrap gap-2 pt-4 border-t border-stone-100">
                {article.tags.map((t, idx) => (
                  <button
                    ...
                    className="text-xs font-semibold px-3 py-1 rounded-full bg-emerald-50 hover:bg-emerald-100 text-emerald-800 transition-colors cursor-pointer"
                  >
                    #{t}
                  </button>
                ))}
            ...
            {/* Interaction Bar */}
            <div className="mt-8 p-3 rounded-2xl bg-stone-100 flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-2 rounded-full bg-white text-stone-700 hover:bg-stone-50 text-xs font-bold cursor-pointer"
                >
                ...
                <button
                  ...
                  className="p-2 text-stone-400 hover:text-red-600 hover:bg-white rounded-full transition-colors cursor-pointer"
            ...
            <section className="mt-10 pt-6 border-t border-stone-200">
              ...
              {isAuthenticated ? (
                  ...
                  <div className="flex gap-3">
                    ...
                    <div className="flex-1">
                      <textarea
                        ...
                        className="w-full p-3 text-sm bg-stone-50 border border-stone-200 rounded-xl focus:outline-none focus:border-emerald-600 focus:bg-white transition-all resize-none"
                      />
                ...
                <div className="mb-8 p-4 rounded-xl bg-stone-50 border border-stone-200 text-center">
              ...
              <div className="space-y-4">
                {comments.length === 0 ? (
                  <p className="text-sm text-stone-400 italic">Soyez le premier à commenter cet article !</p>
                ) : (
                  comments.map((comm) => {
                    ...
                    return (
                      <div
                        key={comm.id}
                        className="p-4 rounded-xl bg-stone-50/80 border border-stone-200/60 transition-colors"
                      >
                        {/* Comment author info */}
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-2">
                            ...
                            />
                            <span className="font-bold text-xs text-stone-900">{comm.userName}</span>
                            {comm.isUserVerified && (
                        ...
                        {editingCommentId === comm.id ? (
                          <div className="mt-2 space-y-2">
                            <textarea
                              ...
                              className="w-full p-2.5 text-xs bg-white border border-stone-300 rounded-lg focus:outline-none focus:border-emerald-600"
                            />
                            <div className="flex justify-end gap-2">
                              <button
                                onClick={() => setEditingCommentId(null)}
                                className="px-3 py-1 text-xs text-stone-600 hover:bg-stone-200 rounded-md cursor-pointer"
                              >
                                Annuler
                              </button>
                              <button
                          ...
                          <p className="mt-2 text-xs sm:text-sm text-stone-800 leading-relaxed whitespace-pre-line">
                            {comm.content}
                          </p>
                        )}
                        ...
                        <div className="mt-3 flex items-center gap-4 text-xs text-stone-500">
                          ...
                          <button
                            ...
                            className={`flex items-center gap-1 font-medium cursor-pointer transition-colors ${
                              comm.isLiked ? 'text-red-600 font-bold' : 'hover:text-red-600'
                            }`}
                          >
                            <Heart className={`w-3.5 h-3.5 ${comm.isLiked ? 'fill-red-600 text-red-600' : ''}`} />
                          ...
                          <button
                            ...
                            className="flex items-center gap-1 font-semibold hover:text-emerald-700 cursor-pointer"
                          >
                          ...
                          <div className="mt-3 pt-3 border-t border-stone-200">
                            <div className="flex gap-2">
                              <input
                                ...
                                className="flex-1 px-3 py-1.5 text-xs bg-white border border-stone-200 rounded-lg focus:outline-none focus:border-emerald-600"
                              />
                              <button
                              ...
                              <button
                                ...
                                className="px-2 py-1.5 text-stone-400 hover:text-stone-600 text-xs cursor-pointer"
                              >
                                Annuler
                              </button>
                            </div>
                        ...
                        {comm.replies && comm.replies.length > 0 && (
                          <div className="mt-3 pl-4 sm:pl-6 border-l-2 border-stone-200 space-y-3">
                                ...
                                <div key={reply.id} className="pt-2">
                                  <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-2">
                                      ...
                                      />
                                      <span className="font-bold text-xs text-stone-900">{reply.userName}</span>
                                  ...
                                  <div className="mt-1.5 flex items-center gap-3 text-[11px] text-stone-500">
                                    <button
                                      ...
                                      className={`flex items-center gap-1 cursor-pointer ${
                                        reply.isLiked ? 'text-red-600 font-bold' : 'hover:text-red-600'
                                      }`}
                                    >
                                      <Heart className={`w-3 h-3 ${reply.isLiked ? 'fill-red-600 text-red-600' : ''}`} />
        ...
        {showReportModal && (
          <div className="fixed inset-0 z-60 flex items-center justify-center bg-black/70 p-4">
            <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-2xl animate-in zoom-in-95">
              ...
              {reportSuccess ? (
                <div className="mt-6 p-4 bg-emerald-50 text-emerald-800 rounded-xl text-center font-medium text-sm">
                ...
                <form onSubmit={handleSendArticleReport} className="mt-4 space-y-3">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full p-2.5 text-xs bg-stone-50 border border-stone-200 rounded-lg focus:outline-none focus:border-emerald-600"
                    >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full p-2.5 text-xs bg-stone-50 border border-stone-200 rounded-lg focus:outline-none focus:border-emerald-600 resize-none"
                    />
                  </div>
