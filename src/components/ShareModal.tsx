  ...
  const shareOptions = [
    {
      ...
      url: `https://api.whatsapp.com/send?text=${encodeURIComponent(`${shareTitle} - FasoInfo\n${shareUrl}`)}`,
    },
    {
      name: 'Facebook',
      icon: Globe,
      ...
      >
        ...
        <div className="p-4 sm:p-5 border-b border-stone-100 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-bold text-stone-900 text-sm sm:text-base">Partager cet article</h3>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-4 sm:p-5 space-y-4">
          ...
          <div className="p-3 bg-stone-50 rounded-xl border border-stone-200 flex gap-3 items-center">
            {article.coverImage && (
              <img
            ...
            <div className="min-w-0">
              ...
              <p className="font-bold text-xs sm:text-sm text-stone-900 line-clamp-2 leading-snug">
                {article.title}
              </p>
            </div>
          </div>
            ...
            {shareOptions.map((opt) => {
              ...
              return (
                <a
                  ...
                  className={`flex items-center gap-2.5 p-3 rounded-xl font-semibold text-xs transition-all shadow-xs ${opt.color}`}
                >
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                readOnly
                value={shareUrl}
                className="flex-1 px-3 py-2 text-xs bg-stone-50 border border-stone-200 rounded-xl text-stone-700 select-all focus:outline-none"
              />
              <button
                type="button"
                onClick={handleCopy}
